...
// Main Component
export default function Timonelyatemotor() {
  return (
    <div >
        <Header />
                  ...
                  <div className="grid gap-8 md:grid-cols-2 items-start">
                    ...
                    <div className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                          ...
                          <p className="text-gray-500 ">
                            <span className="mr-3">&#9875;</span>
                            Clases Prácticas: 2 Clases teórico-prácticas en sede del Club Náutico Córdoba
                          </p>
                        </div>
                    </div>
                </div>
